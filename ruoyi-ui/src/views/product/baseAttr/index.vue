  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属分组" prop="catelogId">
          <el-select v-model="form.attrGroupId" placeholder="请选择所属分组" clearable>
            <el-option :key="item.attrGroupId" :value="item.attrGroupId" :label="item.attrGroupName"
